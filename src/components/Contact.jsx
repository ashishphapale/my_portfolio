...
export default function Contact(){
  ...
  const toEmailLink = import.meta.env.VITE_CONTACT_TO_EMAIL || 'ashishphapale86@gmail.com'
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      const toEmail = import.meta.env.VITE_CONTACT_TO_EMAIL || 'ashishphapale86@gmail.com'
        ...
        <form onSubmit={onSubmit} className="card" data-aos="fade-up" style={{display:'grid', gap:14}}>
          <div style={{display:'grid', gap:8}}>
            ...
            <input
              ...
              required
              style={{width:'100%', padding:12, borderRadius:10, border:'1px solid color-mix(in oklab, var(--text), transparent 85%)'}}
            />
          </div>
          <div style={{display:'grid', gap:8}}>
